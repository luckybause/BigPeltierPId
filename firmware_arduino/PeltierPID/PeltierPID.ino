...
//
//  STEROWANIE: PID + Feed-Forward (tylko grzanie)
...
// ── PID + Feed-Forward (tylko grzanie) ────────────────────────
int compPID(float temp){
  ...
  float lo = htg ? 0.0f : -(float)PWM_MAX;
  float hi = htg ? (float)PWM_MAX : 0.0f;
